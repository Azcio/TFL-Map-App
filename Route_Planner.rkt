...
;; The route function - Not linked to the gui yet and theres not (x y) yet gotta do - Erik x sun tzu
...
(struct stations_info (station-name station-distance station-time station-long-lat)#:mutable)

(define london_underground_struct (list (stations_info Walthamstow_Central 5 68 #(51.4892 -0.1337))
                                        (stations_info Blackhorse_Road 12 142 #(51.5863 -0.0412))
                                        (stations_info Tottenham_Hale 8 142 #(51.5886 -0.0596))
                                        (stations_info Seven_Sisters 6 152 #(51.5822 -0.0740))
                                        (stations_info Finsbury_Park 9 102 #(51.5643 -0.1065))
                                        (stations_info Highbury_&_Islington 8 150 #(51.5247 -0.1384))
                                        (stations_info Kings_Cross_St_Pancras 5 32 #(51.5247 -0.1384))
                                        (stations_info Hammersmith 4 68 #(51.4936 -0.2253))
                                        (stations_info Goldhawk_Road 4 79 #(51.5025 -0.2261))
                                        (stations_info Shepherd_s_Bush_Market 8 42 #(51.5051 -0.2267))
                                        (stations_info Wood_Lane 3 64 #(51.5098 -0.2241))
                                        (stations_info Latimer_Road 8 144 #(51.5135 -0.2176))
                                        (stations_info Ladbroke_Grove 4 102 #(51.5174 -0.2107))
                                        (stations_info Westbourne_Park 6 126 #(51.5211 -0.2013))
                                        (stations_info Royal_Oak 3 67 #(51.5195 -0.1889))
                                        (stations_info Paddington 2 42 #(51.5154 -0.1758))
                                        (stations_info Edgware_Road 8 89 #(51.5154 -0.1758))
                                        (stations_info Baker_Street 4 62 #( 51.5225 -0.1570))
                                        (stations_info Great_Portland_Street 8 42 #(51.5235 -0.1432))
                                        (stations_info Euston_Square 8 72 #(51.5250 -0.1351))
                                        (stations_info Farringdon 5 83 #(51.5202 -0.1055))
                                        (stations_info Barbican 6 98 #(51.5203 -0.0977))
                                        (stations_info Moorgate 7 103 #(51.5183 -0.0886))
                                        (stations_info Liverpool_Street 8 42 #(51.5178 -0.0824))
                                        (stations_info Aldgate 8 176 #(51.5142 -0.0759))
                                        (stations_info Tower_Hill 58 157 #(51.5098 -0.0765))
                                        (stations_info Monument 3 49 #(51.5108 -0.0847))
                                        (stations_info Cannon_Street 9 68 #(51.511353,-0.090212))
                                        (stations_info Mansion_House 1 125 #(51.513274,-0.093210))
                                        (stations_info Blackfriars 2 50 #(51.511648,-0.103906))
                                        (stations_info Temple 8 61 #(51.511226,-0.114903))))
